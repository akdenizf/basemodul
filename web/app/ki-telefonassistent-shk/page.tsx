...
const pilotSteps = [
  { number: "01", title: "Scoping & Baseline · Tag 0–5", text: "Wir legen Eingangskanal, Pflichtfelder, Zuständigkeiten, Eskalationsregeln und verfügbare Ausgangsdaten fest." },
  { number: "02", title: "Konfiguration & Test · Tag 6–12", text: "Wir prüfen Testfälle, menschliche Übergabe und Fallback. Erst nach Ihrer Freigabe startet der Ablauf produktiv." },
  { number: "03", title: "Pilot & Entscheidung · Tag 13–30", text: "Sie bewerten reale Übergaben, Rückrufe, Korrekturen und die Scorecard – und entscheiden dann über Ausbau, Nachschärfung oder Pause." },
];
